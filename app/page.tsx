...
import { revokeAdminAccess } from "@/lib/admin-access";
    ...
    <PageTransition>
      <main className="min-h-screen bg-bg-primary">
        <div className="container mx-auto px-4 py-12 md:px-6 lg:px-8 max-w-6xl">
          ...
          {/* Divider */}
          <motion.div
            className="h-px bg-linear-to-r from-transparent via-border-subtle to-transparent mb-12"
          ...
          >
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="hidden sm:flex items-center gap-2 text-text-muted text-sm">
                ...
                <span>Live</span>
                <span className="w-2 h-2 rounded-full bg-status-wip ml-3"></span>
                <span>WIP</span>
                <span className="w-2 h-2 rounded-full bg-status-archived ml-3"></span>
                <span>Archived</span>
              </div>
            </div>
          ...
          >
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-text-muted text-sm">
              <p>© {new Date().getFullYear()} Anshul. All rights reserved.</p>
